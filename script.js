...
function seedDemo() {
  ...
  const assignments = [
    ...
    {id:uid('assign'),role:'Modérateur',workerId:workers[1].id,workerName:workers[1].name,response:'pending'}
  ];
...
function bindEvents() {
  ...
  document.getElementById('openActivityModal').addEventListener('click', () => { refreshWorkerSelects(); openModal('activityModal'); });
